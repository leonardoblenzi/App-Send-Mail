					...
					<div class="card-body font-weight-bold">
						<form action="processa_envio.php" method="post">
							<div class="form-group">
								...
								<input name="destino" type="text" class="form-control" id="para" placeholder="joao@dominio.com.br" required>
							</div>
							...
							<?php if(isset($_GET['inv'])) { ?>
						        <div class="inv w-50 mx-auto"> 
						          <p class="mt-3 text-center">Tentativa invalida. Preencha corretamente para continuar.</p>
						        </div>
      						<?php } ?>
